...
class __$$PageChangedImplCopyWithImpl<$Res>
    extends _$MainStateCopyWithImpl<$Res, _$PageChangedImpl>
...
class _$PageChangedImpl implements _PageChanged {
  ...
  @override
  String toString() {
    return 'MainState.pageChanged(pageIndex: $pageIndex)';
  }
...
abstract class _PageChanged implements MainState {
  const factory _PageChanged({required final int pageIndex}) =
      _$PageChangedImpl;
